...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(ENABLE_DISCOVERY ON)
...
if (ENABLE_DISCOVERY)
    find_package(Avahi 0.6.31 REQUIRED)
    find_package(Gssdp 0.13.2 REQUIRED)
    find_package(Gupnp 0.20.2 REQUIRED)
endif ()
...
if (ENABLE_DISCOVERY)
  set(ENABLE_DISCOVERY 1)
#  add_definitions(-DENABLE_DISCOVERY=1)
endif ()
